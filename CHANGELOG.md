...
- Improved mobile Markdown typing, paste and keyboard-dismissal stability by keeping the live textarea grow-only during input and software-keyboard viewport changes, with full height recalculation reserved for safe view/render transitions.
